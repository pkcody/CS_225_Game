...
namespace SpatialPartitionPattern
{
    public class Grid
    {
        ...
        public Soldier FindClosestFriendly(Soldier enemySoldiers)
        {
            //Determine which grid cell the friendly soldier is in
            int cellX = (int)(enemySoldiers.soldierTrans.position.x / cellSize);
            int cellZ = (int)(enemySoldiers.soldierTrans.position.z / cellSize);
            ...
            while (enemy != null)
            {
                ...
                float distSqr = (enemy.soldierTrans.position - enemySoldiers.soldierTrans.position).sqrMagnitude;
